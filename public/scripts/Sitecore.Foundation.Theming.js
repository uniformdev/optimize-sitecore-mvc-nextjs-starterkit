...
(function ($) {
    document.addEventListener('uniform.pageload', function () {
        ...
        // see on /uniform/api/content/habitat/html/modules/feature/demo.json
        ...
        if(chart.hasAttribute('data-uniform-pageload')) {
          return;
        }
        else{
          chart.setAttribute('data-uniform-pageload', '1');
        }
